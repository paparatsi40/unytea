...
export const components = {
  ...
  button: {
    primary:
      "rounded-xl bg-gradient-to-r from-violet-500 to-purple-600 px-6 py-3 font-semibold text-white shadow-lg shadow-violet-500/30 transition-all hover:shadow-xl hover:shadow-violet-500/40 active:scale-95",
    secondary:
      "rounded-xl border border-border bg-card px-6 py-3 font-semibold transition-all hover:bg-accent active:scale-95",
  ...
  badge: {
    primary:
      "rounded-full bg-violet-500/10 px-3 py-1 text-sm font-medium text-violet-600 dark:text-violet-400",
    success:
      "rounded-full bg-green-500/10 px-3 py-1 text-sm font-medium text-green-600 dark:text-green-400",
    warning:
      "rounded-full bg-amber-500/10 px-3 py-1 text-sm font-medium text-amber-600 dark:text-amber-400",
    error:
      "rounded-full bg-red-500/10 px-3 py-1 text-sm font-medium text-red-600 dark:text-red-400",
  },
};
