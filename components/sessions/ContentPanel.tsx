...
const WhiteboardCanvas = dynamic(
  () =>
    import("./WhiteboardCanvas").then((mod) => ({
      default: mod.WhiteboardCanvas,
    })),
  {
    ssr: false,
    loading: () => (
...
type ContentType = "whiteboard" | "files" | "video";
      ...
      <div className="flex-1 overflow-hidden">
        ...
        >
          ...
          <TabsContent value="whiteboard" className="flex-1 m-0 p-0">
            <WhiteboardCanvas sessionId={sessionId} isModerator={isModerator} />
          </TabsContent>
          ...
          <TabsContent value="video" className="flex-1 m-0 p-0">
            <VideoEmbed isModerator={isModerator} />
          </TabsContent>
        </Tabs>
      </div>
