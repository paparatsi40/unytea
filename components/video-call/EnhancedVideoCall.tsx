...
function VideoCallInterface({
  ...
  useEffect(() => {
    ...
    // @ts-expect-error - Listener type mismatch but works at runtime
  ...
  const handleReact = (type: ReactionType) => {
    ...
    handleReactionReceived(reaction); // Add locally immediately
  };
  ...
  const handleMarkAnsweredAction = (messageId: string) => {
    ...
    handleMarkAnswered(messageId, participantName);
  };
