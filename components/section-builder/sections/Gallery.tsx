  ...
  return (
    <section className="rounded-2xl border border-border bg-white p-8 md:p-16">
      <div className="mb-12 text-center">
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">{title || "Gallery"}</h2>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {images.map((url, i) => (
          <div
            key={i}
            className="group relative aspect-video overflow-hidden rounded-xl bg-gray-100 shadow-lg"
          >
            <Image
              src={url}
