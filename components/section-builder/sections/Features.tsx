      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {featureItems.map((item: string, i: number) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900">{item || `Feature ${i + 1}`}</h3>
            <p className="mt-2 text-sm text-gray-600">Description of this amazing feature</p>
          </div>
        ))}
      </div>
    </section>
...
export const FeaturesSchema: SectionSchema = {
  ...
  defaultProps: {
    ...
    itemsCsv:
      "Exclusive Resources, Live Events, Expert Mentorship, Community Support, Course Library, Networking",
  },
  fields: [
