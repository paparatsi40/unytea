      ...
      {showPreview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="relative">
            ...
            <div
              ref={cardRef}
              className="w-[400px] rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 text-white shadow-2xl"
              style={{
            ...
            >
              ...
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold">{communityName}</h3>
                  <p className="text-sm text-slate-400">Community Growth</p>
                </div>
              </div>
            ...
            <div className="mt-4 flex justify-center gap-3">
              ...
              <Button onClick={generateImage} disabled={isGenerating} className="gap-2">
