...
export const config = {
  matcher: [
    // Excluye Next.js internals, assets estáticos, API, PWA files y archivos SEO (sitemap.xml, robots.txt).
    // Sin sitemap.xml/robots.txt en la lista negra, intlMiddleware redirigía /sitemap.xml -> /en/sitemap.xml -> 404.
