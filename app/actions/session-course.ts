...
export const addSessionToCourse = defineAction(
  ...
  async (
    ...
    sessionId: string,
    courseId: string,
    options?: { moduleId?: string; lessonTitle?: string; isFree?: boolean; source?: string }
  ) => {
    try {
...
export const createCourseFromSession = defineAction(
  ...
  async (
    ...
    sessionId: string,
    courseTitle: string,
    options?: { description?: string; isPaid?: boolean; price?: number; source?: string }
  ) => {
    try {
      const userId = ctx.userId;
...
export const createResourceFromSession = defineAction(
  ...
  async (
    ctx,
    sessionId: string,
    options?: { source?: string; title?: string; description?: string; isPublic?: boolean }
  ) => {
    try {
      const userId = ctx.userId;
