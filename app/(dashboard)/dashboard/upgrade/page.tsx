  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground">{t("headerSubtitle")}</p>
        <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground">{t("headerDetail")}</p>
      </div>
