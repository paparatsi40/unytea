        ...
        {steps.map((s, index) => (
          <div key={s.id} className="flex flex-1 items-center">
            ...
            {index < steps.length - 1 && (
              <div
                className={`mx-4 h-0.5 flex-1 ${index < currentStep ? "bg-primary" : "bg-border"}`}
              />
            )}
          </div>
        ))}
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="h-12 w-full cursor-pointer rounded-lg border border-border bg-background"
                  />
                </div>
