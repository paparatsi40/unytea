...
import { User as UserIcon, Loader2, CheckCircle2, Upload, MapPin, Globe, Clock } from "lucide-react";
        ...
        <div className="rounded-xl border border-border/50 bg-card/50 p-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              value={user.email || ""}
              disabled
              className="w-full rounded-lg border border-border bg-muted px-4 py-2 text-sm text-muted-foreground cursor-not-allowed"
            />
