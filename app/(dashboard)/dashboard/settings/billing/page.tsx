            ...
            <div className="flex items-center gap-2">
              ...
              <CardTitle>
                {isLoadingData ? (
                  ...
                  t("currentPlan", { plan: platformPlan })
                )}
              </CardTitle>
            </div>
            {isSubscribed && (
            ...
            {subscription ? (
              <div className="space-y-1 text-sm">
                ...
                {subscription.cancelAtPeriodEnd && (
                  <p className="text-red-600">{t("willCancel")}</p>
                )}
              </div>
            ) : platformPlan === "START" ? (
              t("selectPlanTrial")
        ...
        <CardContent>
          {isSubscribed ? (
            <div className="flex flex-col items-center justify-center gap-4 py-6 text-center">
              <p className="text-sm text-muted-foreground">{t("paymentMethodsStripe")}</p>
              <Button
                variant="outline"
                onClick={handleManageSubscription}
                disabled={isPortalLoading}
            ...
            <div className="flex flex-col items-center justify-center gap-4 py-8 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t("autoAddedOnUpgrade")}</p>
              </div>
            </div>
          )}
        </CardContent>
